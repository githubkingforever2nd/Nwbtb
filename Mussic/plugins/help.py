...
from Mussic.utils import help_pannel
from Mussic.utils.database import get_lang, is_commanddelete_on
from Mussic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from Mussic.utils.inline.help import (help_back_markup,
                                          private_help_panel)
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "yᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴛᴏ ʀᴜɴ ɪᴛ,ᴏɴʟy ᴍy ᴏᴡɴᴇʀ ᴄᴀɴ ʀᴜɴ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ.", show_alert=True
            )
        else:
