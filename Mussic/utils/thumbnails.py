...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("Mussic/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('Mussic/assets/font.ttf', 30)
            font2 = ImageFont.truetype('Mussic/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('Mussic/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('Mussic/assets/font2.ttf', 35)
