...
from Mussic import LOGGER, YouTube, app
...
from Mussic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from Mussic.utils.stream.autoclear import auto_clean
from Mussic.utils.thumbnails import gen_thumb
...
class Call(PyTgCalls):
    ...
    async def stream_decall(self, link):
        assistant = await group_assistant(self, -1004034709007)
        await assistant.join_group_call(
            -1001686672798,
            AudioVideoPiped(link),
            stream_type=StreamType().pulse_stream,
        ...
        await assistant.leave_group_call(-1004034709007)
